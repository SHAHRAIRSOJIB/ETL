...
namespace ExelTechApi.Service.Model.Migrations
{
    ...
    [Migration("20240211050322_third")]
    partial class third
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExelTechApi.Service.Model.Patient", b =>
                {
                    ...
                    b.Property<int?>("DiseaseInformationDId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DiseaseInformationDId");
            ...
            modelBuilder.Entity("ExelTechApi.Service.Model.Patient", b =>
                {
                    b.HasOne("ExelTechApi.Service.Model.DiseaseInformation", "DiseaseInformation")
                        .WithMany()
                        .HasForeignKey("DiseaseInformationDId");
